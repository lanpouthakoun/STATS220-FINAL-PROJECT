...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 11, "cvodeieq");
 	...
 	ivoc_help("help ?1 mammalian_spike /nfs/pool0/mikesomm/STATS220-FINAL-PROJECT/nrn/mammalian_spike.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/nfs/pool0/mikesomm/STATS220-FINAL-PROJECT/nrn/mammalian_spike.mod";
static const char* nmodl_file_text = 
